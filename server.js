...
.crest-large{width:230px;height:230px;margin:auto;position:relative;display:grid;place-items:center;filter:drop-shadow(0 25px 45px rgba(0,0,0,.55))}.crest-ring{position:absolute;inset:8px;border:1px solid rgba(214,177,90,.55);border-radius:50%;box-shadow:0 0 50px rgba(214,177,90,.08)}.crest-ring:before{content:"";position:absolute;inset:17px;border:1px solid rgba(203,208,212,.2);border-radius:50%}.crest-crown{width:86px;height:92px;position:relative;clip-path:polygon(0 100%,0 25%,22% 48%,50% 0,78% 48%,100% 25%,100% 100%);background:linear-gradient(135deg,#f0d37a 0%,#80652d 38%,#e5c76d 60%,#4b3b1d 100%);box-shadow:0 0 35px rgba(214,177,90,.18)}.crest-flame{position:absolute;top:36px;width:28px;height:48px;border:1px solid var(--gb);border-radius:60% 40% 60% 40%;transform:rotate(45deg);background:radial-gradient(circle at 60% 65%,#f3da8c,transparent 60%);opacity:.9}.crest-caption{position:absolute;bottom:-25px;width:100%;text-align:center;color:#777;font-size:9px;letter-spacing:.22em;text-transform:uppercase}
.instrument{min-height:390px;border:1px solid rgba(203,208,212,.18);display:grid;place-items:center;position:relative;overflow:hidden;background:radial-gradient(circle,rgba(214,177,90,.1),transparent 56%),#080808;box-shadow:inset 0 0 60px rgba(255,255,255,.025),0 30px 100px rgba(0,0,0,.5)}
...
<section id="crest"><div class="shell crest-section"><div><div class="label">05 / The Author’s Crest</div><h2>A mark for the discipline.</h2><p class="intro">The crest is intended as a visual signature for the emerging IFD corpus: structured identity, coherent symbolic form, and an orientation toward the horizon.</p></div><div class="crest-large" aria-label="The Author’s Crest"><div class="crest-ring"></div><div class="crest-crown"></div><div class="crest-flame"></div><div class="crest-caption">Iᴴ · C∞ · W₀ · S</div></div></div></section>
</main>
