...
.crest-large{width:min(100%,620px);margin:auto;position:relative;filter:drop-shadow(0 30px 55px rgba(0,0,0,.72));}.crest-art{display:block;width:100%;height:auto;border-radius:18px;box-shadow:0 30px 90px rgba(0,0,0,.62),0 0 70px rgba(214,177,90,.12);mask-image:radial-gradient(ellipse at center,#000 68%,transparent 100%)}.crest-caption{position:absolute;bottom:2%;left:0;right:0;text-align:center;color:#aaa69c;font-size:10px;letter-spacing:.3em;text-transform:uppercase;text-shadow:0 0 14px rgba(214,177,90,.35)}.instrument{min-height:390px;border:1px solid rgba(203,208,212,.18);display:grid;place-items:center;position:relative;overflow:hidden;background:radial-gradient(circle,rgba(214,177,90,.1),transparent 56%),#080808;box-shadow:inset 0 0 60px rgba(255,255,255,.025),0 30px 100px rgba(0,0,0,.5)}
...
<section id="crest"><div class="shell crest-section"><div><div class="label">05 / The Author’s Crest</div><h2>A mark for the discipline.</h2><p class="intro">The crest is intended as a visual signature for the emerging IFD corpus: structured identity, coherent symbolic form, and an orientation toward the horizon.</p></div><div class="crest-large" aria-label="The Author’s Crest"><img class="crest-art" src="/author-crest.svg" alt="The Author’s Crest: a gold and obsidian crown suspended over a luminous horizon ring, crossed by a vertical beam."><div class="crest-caption">Iᴴ · C∞ · W₀ · S</div></div></div></section>
</main>
