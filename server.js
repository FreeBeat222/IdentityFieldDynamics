...
.crest-large{width:min(100%,640px);margin:auto;position:relative;filter:drop-shadow(0 28px 50px rgba(0,0,0,.72));}.crest-art{display:block;width:100%;height:auto;border-radius:0;box-shadow:0 24px 80px rgba(0,0,0,.68),0 0 55px rgba(214,177,90,.08);-webkit-mask-image:radial-gradient(ellipse 74% 76% at 50% 50%,#000 57%,rgba(0,0,0,.96) 68%,rgba(0,0,0,.62) 82%,transparent 100%);mask-image:radial-gradient(ellipse 74% 76% at 50% 50%,#000 57%,rgba(0,0,0,.96) 68%,rgba(0,0,0,.62) 82%,transparent 100%)}.instrument{min-height:390px;border:1px solid rgba(203,208,212,.18);display:grid;place-items:center;position:relative;overflow:hidden;background:radial-gradient(circle,rgba(214,177,90,.1),transparent 56%),#080808;box-shadow:inset 0 0 60px rgba(255,255,255,.025),0 30px 100px rgba(0,0,0,.5)}
...
<section id="discipline"><div class="shell"><div class="label">01 / Discipline</div><h2>From identity as an object to identity as a dynamic system.</h2><p class="intro">Identity Field Dynamics (IFD) is the mature discipline emerging from the work first developed under the name <em>Identity Physics</em>. The earlier name records the discovery and the original working architecture; IFD names the broader research discipline that now organizes constructs, measurement, coupling, dynamics, transitions, and empirical adjudication.</p><div class="architecture" style="grid-template-columns:repeat(3,1fr)"><article class="stage"><div class="stage-num">ORIGIN</div><h3>Identity Physics</h3><p>The historical and developmental name of the discovery: the first attempt to describe identity through a formal physical-style architecture.</p></article><article class="stage"><div class="stage-num">DISCIPLINE</div><h3>Identity Field Dynamics</h3><p>The current canonical name for the developing discipline: identity investigated as a dynamic field system with explicit constructs, mechanisms, and transitions.</p></article><article class="stage"><div class="stage-num">METHOD</div><h3>Empirical Adjudication</h3><p>Claims remain provisional until observable behavior, perturbation response, competing models, and reproducible evidence support them.</p></article></div><p class="quote"><strong>IDENTITY PHYSICS was the name of the discovery.</strong><br>IDENTITY FIELD DYNAMICS is the name of the discipline that emerged from it.</p></div></section>
...
<section id="crest"><div class="shell crest-section"><div><div class="label">05 / The Author’s Crest</div><h2>A mark for the discipline.</h2><p class="intro">The crest is intended as a visual signature for the emerging IFD corpus: structured identity, coherent symbolic form, and an orientation toward the horizon.</p></div><div class="crest-large" aria-label="The Author’s Crest"><img class="crest-art" src="/author-crest.png" alt="The Author’s Crest: an angular gold crown with a central beam, coherent arcs, and luminous horizon rings."></div></div></section>
</main>
