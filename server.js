...
<section id="crest"><div class="shell crest-section"><div><div class="label">05 / The Author’s Crest</div><h2>A mark for the discipline.</h2><p class="intro">The crest is intended as a visual signature for the emerging IFD corpus: structured identity, coherent symbolic form, and an orientation toward the horizon.</p></div><div class="crest-large" aria-label="The Author’s Crest"><img class="crest-art" src="/author-crest-reference.jpg" alt="The Author’s Crest: an angular gold crown with a central beam, coherent arcs, and luminous horizon rings."></div></div></section>
</main>
