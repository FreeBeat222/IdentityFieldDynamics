...
section{padding:100px 0;border-top:1px solid rgba(203,208,212,.09)}.label{margin-bottom:18px}h2{margin:0 0 24px;font-size:clamp(34px,5vw,62px);letter-spacing:-.04em}.intro{color:#aaa9a4;max-width:720px;line-height:1.75;font-size:17px}
...
@media(max-width:820px){.links{display:none}.hero-grid{grid-template-columns:1fr;gap:55px}.instrument{min-height:300px}.axes{grid-template-columns:1fr}.shell{width:min(100% - 28px,1180px)}}
</style>
</head>
<body>
<header><div class="shell"><nav>
<a class="mark" href="#top"><span class="crest"><span>IFD</span></span><span>IDENTITY FIELD DYNAMICS</span></a>
<div class="links"><a href="#discipline">Discipline</a><a href="#framework">Framework</a><a href="#research">Research</a><a href="#codex">Codex</a></div>
</nav></div></header>
<main id="top">
<section class="hero"><div class="shell hero-grid"><div>
<div class="eyebrow">A developing scientific discipline</div>
